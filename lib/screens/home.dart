                ...
                child: Card(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('Health Tips For Today', style: TextStyle(color: Colors.white, fontSize: 25) ),
    ...
    return InkWell(
      onTap: (){
        if(menuItem.subtitle.toLowerCase().contains("diagnostics")){
          ...
          Navigator.push(context, MaterialPageRoute(builder: (BuildContext context) => SelectScreen()));
